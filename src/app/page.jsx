...
<Link className="ml-auto text-base text-gray-700 hover:text-gray-600 whitespace-nowrap truncate " href={`/categories/author/John Doe`}>
John Doe
</Link>
    </div>
    <Link href={`/article/${post.slug}`} className="inline-block mt-6 text-xl font-semibold text-zinc-800 hover:text-zinc-500 ">{post.title}</Link>
  </div>
</li>
        ))}
      </ul>
